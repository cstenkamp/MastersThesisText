...
There were some Hyperparameters (also Algorithmen/Komponenten) von \cite{Ager2018} und \cite{Alshaikh2020} die ich noch nicht implementiert hab
...
* Filtering Terms
    * NDCG statt Kappa (like \cite{Ager2018})
