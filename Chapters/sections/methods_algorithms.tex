...
\subsubsection{Clustering the extracted candidates\arrowref{sec:algorithmsteps}}
\label{sec:algo:cluster}


\todoparagraph{And recalculate their feature directions}

\todoparagraph{THat I am using a better technique than Derrac here!}
