...
\begin{table}[h]
	...
	\slcaption{Words that exceed various \gls{df} thresholds for the Siddata, Places and Movies datasets. In \cite{Derrac2015}, the candidate-threshold for placetypes was 50, and the threshold for movies 100. Note that the last two columns are relative and depend on the dataset-size.}
