...
\todoparagraph{SCHON HIER, VOR DEN SUBTEILEN HIERVON, KLAR MACHEN} "ich replizier diese 3 algorithmen, aus diesen 3 papern (und dann in Dataset-section: "Die 3 haupt-autoren nutzen halt diesen algo auf diesen datasets" -> damit auch main-claim (Kommentar Johannes, es war sehr unklar welche datasets mich inwieweit interessieren und warum ich drauf eingehe undso)
