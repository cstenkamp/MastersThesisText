        ...
        \begin{tabular}{@{}llllll@{}} 
        	\toprule
        		...
        		% & \textbf{key feature sizes} 
        		 \\ \midrule
        	\textbf{movies\tablefootnote{\label{origdsets}\url{https://www.cs.cf.ac.uk/semanticspaces/}} \cite{Derrac2015} \cite{Ager2018} \cite{Alshaikh2020} } &
        		...
        		\specialcell[l]{ \tabitem genre (23 classes)\\ \tabitem plot keywords (eg. \textit{suicide, beach}) (100 classes) \\ \tabitem age-rating certificates (6 classes)} & \specialcell[l]{\acrshort{tf} $\geq 100$ \\ \textrightarrow around 22k candidates \\ variable-length \textbf{n-grams} considered}
