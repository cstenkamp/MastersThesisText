...
\documentclass[11pt,
  paper=a4, 
  twoside,  %TODO if it comes to twopage, I have to update the fancyhdr parts (like in my BA)
  hidelinks,
...
\providepairofpagestyles[thesisSimple]{thesis}{%
	\automark*[subsection]{section} %gives section+subsection as header
	% \automark*[section]{}%  %would give section as header
}
...
% ================== chapter name in the head of all sections ==================
% \usepackage{fancyhdr}

% %from fancyhdr
% \usepackage{etoc}  %this and the 2 below to have fancyhdr (chapter in head) correctly in the TOC (https://tex.stackexchange.com/a/167851/108199)
% \renewcommand{\etocaftertitlehook}{\pagestyle{plain}}
% \renewcommand{\etocaftertochook}{\thispagestyle{plain}}

% % fancy page style where new chapters start: https://tex.stackexchange.com/q/117328/108199
...
% % ================== chapter name in the head of all pages ==================
% \pagestyle{fancy}
% \renewcommand{\chaptermark}[1]{\markboth{#1}{#1}}
% \fancyhead[R]{}
% \fancyhead[L]{\chaptername\ \thechapter\ --\ \leftmark}
% % this: https://tex.stackexchange.com/a/66344/108199
% \rhead{\thepage}
...
% \clearpage %from fancyhdr
% \pagestyle{plain} %from fancyhdr
