...
\usepackage{amssymb} % More math symbols.asd
...
\begin{figure}[H]
	...
	\slcaption{
		...
		Of the 21337 courses left after preprocessing, 18,679 were in german language according to the langdetect python-package\footnote{\url{https://pypi.org/project/langdetect/}, which is a direct port of a java library\ which claims to have 99.8\% accuracy on longer texts\cite{nakatani2010langdetect}}.
		}
\end{figure}
