...
% pdflatex -jobname=thesis_forprinting '\newcommand*{\ForPrinting}{}\input{main}'
% pdflatex -jobname=thesis_nomarkdown '\newcommand*{\NoMarkdown}{}\input{main}'
...
\ifdefined\NoMarkdown
	\makeatletter
	\renewcommand{\@input}[1]{\ignorespaces}
	%TODO: this leads to many errors for some reason (TOC sucks, lists suck, ...)
\fi
...
\printglossary[type=\acronymtype, title=Acronyms,    toctitle=List of Acronyms] 
...
%----------------------------------------------------------------------------------------
	...
	\input{Appendices/AppendixA} %hae to use input and not include, otherwise the order of "Appendix" and the first appendix is wrong
