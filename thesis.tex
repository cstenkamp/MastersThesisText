		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{@{}llllll@{}}
				\toprule
					...
					\textbf{candidate word threshold} \\ \midrule
				\textbf{movies\footnote{\label{origdsets}\url{https://www.cs.cf.ac.uk/semanticspaces/}} \cite{Derrac2015} \cite{Ager2018} \cite{Alshaikh2020} } &
					...
					&
					\specialcell[l]{\cite{Ager2018}: 15000 movies (-1022 dups)\\ \cite{Alshaikh2020}: 13978 movies } &
				...
				\textbf{place types\footref{origdsets} \cite{Derrac2015} \cite{Ager2018} \cite{Alshaikh2020} } &
					bag-of-tags to describe places of that place-type on Flickr &
					&
					1383 place-types &
					\specialcell[l]{ \tabitem category from Geonames (7 classes)\\ \tabitem category from Foursquare (9 classes)\\ \tabitem category from OpenCYC (20 classes) } &
					$\geq$ 50 occurences 
					\\ \midrule
				\textbf{wines\footref{origdsets} \cite{Derrac2015} } &
					TODO &
					&
					&
					&
...
\begin{landscape}
	\begin{table}[]
		...
		\resizebox{\textwidth}{!}{%
			...
			MDS trained with the angular differences between the PPMI weighted BoW Vectors &
