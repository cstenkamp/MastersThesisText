...
\todoparagraph{TODO: jedes mall wenn ich document-frequency sage, meine ich nicht eher term-frequncy???!!!}
...
\label{sec:glossary}
\glsaddallunused
\printglossary[type=defs,         title=Definitions, toctitle=Definitions, style=long3colheaderMINE, nogroupskip]
