...
Generally, the separatrix splitting positive from negative samples in an $n$-dimensional space $\mathds{R}^n$ is an $n-1$-dimensional subspace (\textit{hyperplane}), which in the case of $\mathds{R}^3$ corresponds to a plane. 
