...
\begin{figure}[h]
	\begin{center}
	  ...
	  \caption[2D visualization of the movies-dissimilarity matrix]{2D visualization of the movies-dissimilarity matrix for the data uploaded by \textcite{Derrac2015}, colored by genre. Generated with \gls{tsne}. See \url{https://github.com/cstenkamp/derive_conceptualspaces/blob/main/notebooks/text_referenced_plots/desc15_mds_2d3d.ipynb} for the origin of this plot.}
...
\begin{figure}[h]
	\begin{center}
	  \makebox[\textwidth][c]{
		...
		\slcaption{Sample classification of a level-2-decisiontree. Visualize in 3D: \url{https://github.com/cstenkamp/derive_conceptualspaces/blob/main/notebooks/text_referenced_plots/display_top3_SIDDATA.ipynb} \arrowback}
