...
\begin{figure}[h]
	\begin{center}
	  ...
	  \slcaption{Variability of Faculty classification Accuracy as Box-Plots.}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
	\begin{tabular}{ll}
	\textbf{Course Number} & \textbf{Course}                                                     \\
	...
	\caption{Sample Duplicates in the Siddata-dataset. \todoparagraph{Compare Notebook}  data_exploration_Siddata2021.ipynb }
